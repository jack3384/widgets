...
class Validator
{
     ...
     */
    public function validate($var,$filterRules)
    {
            ...
            foreach ($rules as $rule) {
                ...
                if (isset($rule[1])) {
                    $status = $this->$rule[0]($var, $rule[1]);
                } else {
                    $status = $this->$rule[0]($var);
                }
                if (!$status) {
                    return false;
                }
     ...
     */
    public function validateArray(array $array,array $filterRules)
    {
        $this->key="";
